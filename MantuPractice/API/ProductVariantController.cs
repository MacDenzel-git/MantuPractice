...
namespace MantuPractice.API
{
    ...
    {
        private readonly ICrudService<ProductVariantDTO> _service;

        public ProductVariantController(ICrudService<ProductVariantDTO> service)
        {
            _service = service;
        }
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] ProductVariantDTO dto)
