...
namespace MantuPractice.API
{
    ...
    {
        private readonly ICrudService<ProductImageDTO> _service;

        public ProductImageController(ICrudService<ProductImageDTO> service)
        {
            _service = service;
        }
        ...
        [HttpPut]
        public async Task<IActionResult> Update([FromBody] ProductImageDTO dto)
